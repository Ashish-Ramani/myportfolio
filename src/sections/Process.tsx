              ...
              {steps.map((step) => {
                ...
                return (
                  <div
                    key={step.number}
                    ref={addToStepRefs}
                    className="p-4 sm:p-5 rounded-xl sm:rounded-2xl glass-light card-hover"
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-mono text-[10px] sm:text-xs text-[#00D4AA]">
                            {step.number}
                          </span>
                        ...
                        <p className="text-xs sm:text-sm text-[#A9B3C2] leading-relaxed">
                          {step.description}
                        </p>
                      </div>
                    </div>
